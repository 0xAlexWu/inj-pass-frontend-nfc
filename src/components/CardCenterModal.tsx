...
function ScannerArtwork({ scanning }: { scanning: boolean }) {
  return (
      ...
      <div className="relative">
        <div className="w-52 h-36 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border-[3px] border-white/20 flex items-center justify-between p-5 shadow-2xl">
          <div className="flex flex-col justify-between h-full">
            <div className="w-12 h-10 rounded bg-gradient-to-br from-cyan-300/30 to-blue-500/20" />
            <div>
              <div className="text-xs text-white/60 font-bold mb-2 uppercase tracking-[0.18em]">Pass Card</div>
              <div className="w-28 h-4 rounded bg-white/5 mb-1" />
...
export default function CardCenterModal({
  ...
  const containerClassName =
    view === 'scanner'
      ? 'relative z-10 w-full max-w-2xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#080d18] shadow-[0_24px_90px_rgba(0,0,0,0.55)]'
      : 'relative z-10 flex h-[min(86vh,920px)] w-full max-w-[1240px] flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-[#080d18] shadow-[0_24px_90px_rgba(0,0,0,0.55)]';
      ...
      <div className={containerClassName}>
            ...
            <div className="flex items-center gap-3">
              {view === 'cards' ? (
                <button
                  ...
                  className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-semibold text-gray-200 transition-all hover:bg-white/10 hover:text-white"
                >
                  Back to Scan
                </button>
              ) : (
        ...
        {view === 'cards' ? (
          ...
          <div className="px-6 pb-6 pt-5 sm:px-7">
            <div className="rounded-[1.75rem] border border-white/10 bg-black/30 px-6 py-8 sm:px-8">
              <div className="flex flex-col items-center justify-center min-h-[420px]">
                {scanState !== 'success' ? (
                  <>
                    <ScannerArtwork scanning={scanState === 'scanning'} />
                  ...
                  <>
                    ...
                    <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/[0.04] p-4 mb-6">
